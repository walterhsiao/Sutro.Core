...
namespace gs
{
    ...
    public interface IFillElementPolygon
    {
        ...
        IFillStrategy FillStrategy { get; }
    }
        ...
        where TSegmentInfo : FillSegmentInfo, new()
    {
        ...
        public IFillStrategy FillStrategy { get; set; } = new DefaultFillStrategy();
    ...
    public class DefaultFillStrategy : IFillStrategy
    {
    ...
    public class BridgeFillStrategy : IFillStrategy
    {
        private readonly SingleMaterialFFFSettings _settings;

        public BridgeFillStrategy(SingleMaterialFFFSettings settings)
        {
            _settings = settings;
        }
        ...
        public double AdjustVolume(double volume)
        {
            return volume * _settings.BridgeVolumeScale;
        }
    }
}